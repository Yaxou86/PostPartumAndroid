...
import app.yassou.postpartumapp.Adapter.ViewPagerAdapter
import app.yassou.postpartumapp.fragments.RadioBoxesFragment
...
class QuestionaireActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(app.yassou.postpartumapp.R.layout.questions_layout)


        questionsRemaining = findViewById(app.yassou.postpartumapp.R.id.questions_remaining)
        topProgressBar = findViewById(app.yassou.postpartumapp.R.id.determinantProgressBar)
    ...
    private fun setDataOnView(questionModel: RetroQuestionnaireDataModel) {
        ...
        questionsViewPager = findViewById(app.yassou.postpartumapp.R.id.pager)
